package com.bhx.firebase.persistence.impl;
...
public class FirebaseServiceImpl implements FirebaseRepositoryService {
    @Override
    public List<String> uploadMuiltiImages(List<Image> images) {
